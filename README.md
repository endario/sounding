...
| OpenCode Go | — | `zen/go/v1/usage` on every Go key: opencode's own auth per isolated identity ([add another](scripts/add-opencode-go-account.sh)), plus any `OPENCODE_2_API_KEY`-shaped launcher variable |
